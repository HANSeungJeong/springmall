package com.example.springmall.sample.vo;
 public class PageMaker {
	...
	private int pagePerBlock; // 한 블락당 보여질 페이지의 수
	private int allCount; // 전체 게시물 갯수
	private int startRow; // 한 페이지에 시작하는 행
	private int lastPage; // 전체 페이지 중 마지막 페이지번호
	private int currentBlock; // 현재 페이지 블록
	private int lastBlock; // 마지막 페이지 블록
	private int startPage; // 현재 페이지 블락의 시작페이지
	private int endPage; // 현재 페이지 블락의 마지막 페이지
	...
	public void setStartRow() {
		int startRow = (getCurrentPage()-1) * getRowPerPage(); //현재 페이지가 1페이지면 0행부터, 2페이지면 10행부터...
	...
	//현재 페이지 블록과 블록당 보여질 페이지의 개수를 이용하여 현재 페이지 블록의 시작 페이지를 구한다.
	...
	//현재 페이지 블록과 마지막 페이지 블록이 같을 때와 다를 때 각각 마지막 페이지가 달라지는 점을 이욯하여 마지막페이지를 구한다.
